...
console.log(strCopy);
// Saída esperada: Array ["A raposa é uma animal esperto"]
...
console.log(frase.startsWith('Sou')); // Verdadeiro - retornar true
console.log(frase.startsWith('a')); // Falso - retornar false

console.log(frase.endsWith('!')); // Verdadeiro - retornar true
console.log(frase.endsWith('bom!')); // Verdadeiro - retornar true
console.log(frase.endsWith('x')); // Falso - retornar false